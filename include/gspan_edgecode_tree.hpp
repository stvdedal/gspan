...
public:
    ...
    typedef typename boost::call_traits<vertex_bundled_type>::param_type
    vertex_bundled_reference;

    typedef EP edge_bundled_type;
    typedef typename boost::call_traits<edge_bundled_type>::param_type
    edge_bundled_reference;
    ...
    typedef typename boost::call_traits<vertex_descriptor>::param_type
    vertex_descriptor_reference;
    typedef typename boost::call_traits<edge_descriptor>::param_type
    edge_descriptor_reference;
    ...
    typedef std::pair<rmpath_edge_iterator, rmpath_edge_iterator>
...
template <typename VP, typename EP, typename D, typename VI, typename EI>
bool
edgecodetree<VP, EP, D, VI, EI>::vertex_descriptor::operator==
(const vertex_descriptor& rhs) const
{
...
template <typename VP, typename EP, typename D, typename VI, typename EI>
bool
edgecodetree<VP, EP, D, VI, EI>::edge_descriptor::operator==
(const edge_descriptor& rhs) const
{
    return _ec == rhs._ec;
}
...
bool
edgecodetree<VP, EP, D, VI, EI>::out_edge_iterator::operator==
(const out_edge_iterator& rhs) const
{
...
template <typename VP, typename EP, typename D, typename VI, typename EI>
edgecodetree<VP, EP, D, VI, EI>::vertex_iterator::vertex_iterator(
    vertex_descriptor v)
    : v_(v)
{
}
...
bool
edgecodetree<VP, EP, D, VI, EI>::vertex_iterator::operator==
(const vertex_iterator& rhs) const
{
    return v_ == rhs.v_;
}
...
edgecodetree<VP, EP, D, VI, EI>::edge_iterator_<pfm>::edge_iterator_
(const edgecodetree* ec)
    : _ec(ec)
{
}
...
bool
edgecodetree<VP, EP, D, VI, EI>::edge_iterator_<pfm>::operator==
(const edge_iterator_& rhs) const
{
    return _ec == rhs._ec;
}
...
template <typename VP, typename EP, typename D, typename VI, typename EI>
typename edgecodetree<VP, EP, D, VI, EI>::out_edge_iterator_pair
out_edges(typename edgecodetree<VP, EP, D, VI, EI>::vertex_descriptor_reference
          v,
...
template <typename VP, typename EP, typename D, typename VI, typename EI>
typename edgecodetree<VP, EP, D, VI, EI>::degree_size_type
out_degree(typename edgecodetree<VP, EP, D, VI, EI>::vertex_descriptor_reference
           v,
           const edgecodetree<VP, EP, D, VI, EI>& g)
{
...
edgecodetree<VP, EP, D, VI, EI>::vertex_index(vertex_descriptor_reference v)
const
{
    return v._index;
}
...
edgecodetree<VP, EP, D, VI, EI>::vertex_value(vertex_descriptor_reference v)
const
{
               ...
               std::cerr)
{
    ...
    for (typename std::vector<typename G::edge_descriptor>::const_reverse_iterator
            ri =
