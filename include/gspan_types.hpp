...
class gspan_traits {
    ...
    using vi_ig_pmap = typename
                       boost::property_map<IG_, boost::vertex_index_t>::const_type;
    using ei_ig_pmap = typename
                       boost::property_map<IG_, boost::edge_index_t>::const_type;
public:
    ...
    /// Edge extentions
    using SG = std::unordered_map<const IG*, SBGS>;
